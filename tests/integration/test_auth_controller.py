...
def test_register_and_login_e2e_flow(client: TestClient) -> None:
    # 1. Probar registro vía HTTP (Guardará el usuario en RAM)
    register_payload = {
    ...
    # 2. Probar login vía HTTP (Consultará la base en RAM)
    login_payload = {
